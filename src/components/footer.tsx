    ...
    <footer className="text-gray-400 bg-gray-900 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap md:text-left text-center order-first">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a className="text-gray-400 hover:text-white">官网建站</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">数字大屏</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">字幕处理</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">Fourth Link</a>
              </li>
      ...
      <div className="bg-gray-800 bg-opacity-75">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <div className="text-sm text-gray-400 sm:ml-6 sm:mt-0 mt-4">
            深圳市九色鹿文化传媒有限公司
            <a
